...
import { FaSearch, FaChevronLeft, FaChevronRight, FaSpinner, FaEye, FaCalendarCheck } from "react-icons/fa";
...
function VendorBookings() {
  ...
  const loadBookings = async () => {
    ...
    try {
      ...
      // Filter out bookings so we show active bookings by default (not completed/cancelled unless filter requires it)
        ...
        <div className="col-md-10 p-0 bg-light" style={{ minHeight: "100vh" }}>
          ...
          <div className="px-4 pb-4">
            <div className="d-flex flex-wrap justify-content-between align-items-center mb-4 gap-3">
              <div>
                <h2 className="fw-bold mb-0 text-dark">📅 Active Venue Bookings</h2>
                <p className="text-muted mb-0">Monitor incoming reservations, schedule timetables, and print bills.</p>
              </div>
            ...
            {loading ? (
              <div className="text-center py-5">
                ...
                <h5 className="mt-3 text-muted">Loading bookings list...</h5>
              </div>
            ) : (
                  ...
                  <table className="table table-hover align-middle mb-0">
                    ...
                    <tbody>
                      {currentItems.length === 0 ? (
                        <tr>
                          <td colSpan="10" className="text-center text-muted py-5">No bookings logged for your turfs.</td>
                        </tr>
                      ) : (
                        currentItems.map((b) => (
                          <tr key={b.id}>
                ...
                <div className="modal-dialog modal-dialog-centered">
                  <div className="modal-content border-0 rounded-4 shadow">
                    ...
                    <div className="modal-body p-4">
                      ...
                      <div className="mb-3 border-bottom pb-2">
                        <span className="small text-muted d-block">Booking Date:</span>
                      ...
                      <div className="mb-1">
                        ...
                        <span className={`badge px-3 py-2 text-uppercase ${
                          viewingBooking.bookingStatus === "CONFIRMED"
                            ? "bg-success"
                            : viewingBooking.bookingStatus === "COMPLETED"
                            ? "bg-primary"
                            : "bg-danger"
