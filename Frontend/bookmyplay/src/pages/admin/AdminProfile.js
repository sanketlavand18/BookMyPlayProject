...
import { FaUserCircle, FaSpinner, FaLock, FaCamera } from "react-icons/fa";
...
function AdminProfile() {
  ...
  const handleUpdateProfile = async (e) => {
    ...
    try {
      ...
      // Update local storage name / pic if needed
    ...
    <div className="container-fluid">
      <div className="row">
        ...
        <div className="col-md-10 p-4">
          <h2 className="fw-bold mb-4">Admin Profile Settings</h2>
